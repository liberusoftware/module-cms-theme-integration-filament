...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the cms-theme-integration public boundary. It m
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-theme-integration-filament?sort=semver)](https://github.com/liberusoftware/module-cms-theme-integration-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-theme-integration-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-theme-integration-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-theme-integration-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-theme-integration-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-theme-integration-filament" alt="Contributors to liberusoftware/module-cms-theme-integration-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-theme-integration-filament/graphs/contributors).
